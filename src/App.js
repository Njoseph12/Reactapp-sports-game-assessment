...
function App() {
  ...
  const Panthers = {
    ...
    logoSrc:
      "https://m.media-amazon.com/images/M/MV5BNjk4N2Q1YzAtYWY4Yy00NGI4LWI5M2YtYmMxZmUwMzEwYWMwXkEyXkFqcGdeQXVyMjkwMzc3Mzg@._V1_.jpg",
  };

  const Gators = {
    name: "Baltimore Gators",
    logoSrc:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSeOchbtL726JAHZF8esQdd5nWtoD5YQRgDcQ&usqp=CAU",
  };
  ...
  return (
    <div className="App">
      <Game venue="Union 525 Gem" homeTeam={Tigers} visitingTeam={Panthers} />
      <Game venue="Sheridan Arena" homeTeam={Gators} visitingTeam={Eagles} />
    </div>
  );
}
